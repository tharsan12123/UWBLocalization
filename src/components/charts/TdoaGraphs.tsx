  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full">
        <div className={`relative ${isFullScreen ? 'w-[850px] h-[500px]' : 'w-[400px] h-[300px]'} mx-auto bg-gray-50 rounded-lg`}>
      ...
      <div className="mb-4">
        <div className="flex gap-2">
          <button
            ...
            className={`px-3 py-1 rounded text-sm ${selectedMethod === 'all'
          ...
          <button
            ...
            className={`px-3 py-1 rounded text-sm ${selectedMethod === 'raw'
          ...
          <button
            ...
            className={`px-3 py-1 rounded text-sm ${selectedMethod === 'kalman'
              ? 'bg-blue-600 text-white'
              : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
              }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1 rounded text-sm ${selectedMethod === 'ml'
